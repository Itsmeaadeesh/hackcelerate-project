    ...
    <Card className="chatbot-container w-full max-w-md mx-auto h-[500px] flex flex-col">
      ...
      <CardFooter className="border-t pt-4">
        <form onSubmit={handleSubmit} className="w-full space-y-2">
          ...
          <div>
            <p className="text-xs text-muted-foreground mb-1">{t("chatbot.suggestions")}:</p>
            <div className="flex flex-wrap gap-1">
              <Button
                ...
                onClick={() => handleSuggestionClick(t("chatbot.suggestion1"))}
              >
              ...
              <Button
                ...
                size="sm"
                className="text-xs h-7"
                onClick={() => handleSuggestionClick(t("chatbot.suggestion2"))}
              >
              ...
              <Button
                ...
                size="sm"
                className="text-xs h-7"
                onClick={() => handleSuggestionClick(t("chatbot.suggestion3"))}
              >
